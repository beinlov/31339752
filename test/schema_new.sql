...
SET NAMES utf8mb4;
 ...
 Source Server         : botnet
 Source Server Type    : MySQL
 Source Server Version : 80012 (8.0.12)
 Source Host           : localhost:3306
 Source Schema         : botnet
 Target Server Type    : MySQL
 Target Server Version : 80012 (8.0.12)
 File Encoding         : 65001
 Date: 27/01/2026 17:35:34
*/
SET NAMES utf8mb4;
SET FOREIGN_KEY_CHECKS = 0;
...
CREATE TABLE `botnet_communications_andromeda`  (
  ...
  `node_id` int(11) NOT NULL COMMENT '关联的节点ID',
  ...
  INDEX `fk_node_andromeda`(`node_id` ASC) USING BTREE,
  CONSTRAINT `fk_node_andromeda` FOREIGN KEY (`node_id`) REFERENCES `botnet_nodes_andromeda` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
CREATE TABLE `botnet_communications_asruex`  (
  ...
  INDEX `idx_communication_time`(`communication_time` ASC) USING BTREE,
  INDEX `idx_location`(`country` ASC, `province` ASC, `city` ASC) USING BTREE,
  INDEX `fk_node_asruex`(`node_id` ASC) USING BTREE,
  CONSTRAINT `fk_node_asruex` FOREIGN KEY (`node_id`) REFERENCES `botnet_nodes_asruex` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
CREATE TABLE `botnet_communications_autoupdate`  (
  ...
  CONSTRAINT `fk_node_autoupdate` FOREIGN KEY (`node_id`) REFERENCES `botnet_nodes_autoupdate` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
CREATE TABLE `botnet_communications_leethozer`  (
  ...
  INDEX `idx_communication_time`(`communication_time` ASC) USING BTREE,
  INDEX `idx_location`(`country` ASC, `province` ASC, `city` ASC) USING BTREE,
  INDEX `fk_node_leethozer`(`node_id` ASC) USING BTREE,
  CONSTRAINT `fk_node_leethozer` FOREIGN KEY (`node_id`) REFERENCES `botnet_nodes_leethozer` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
CREATE TABLE `botnet_communications_moobot`  (
  ...
  INDEX `idx_communication_time`(`communication_time` ASC) USING BTREE,
  INDEX `idx_location`(`country` ASC, `province` ASC, `city` ASC) USING BTREE,
  INDEX `fk_node_moobot`(`node_id` ASC) USING BTREE,
  CONSTRAINT `fk_node_moobot` FOREIGN KEY (`node_id`) REFERENCES `botnet_nodes_moobot` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
CREATE TABLE `botnet_communications_mozi`  (
  ...
  INDEX `idx_communication_time`(`communication_time` ASC) USING BTREE,
  INDEX `idx_location`(`country` ASC, `province` ASC, `city` ASC) USING BTREE,
  INDEX `fk_node_mozi`(`node_id` ASC) USING BTREE,
  CONSTRAINT `fk_node_mozi` FOREIGN KEY (`node_id`) REFERENCES `botnet_nodes_mozi` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
CREATE TABLE `botnet_communications_ramnit`  (
  ...
  INDEX `fk_node_ramnit`(`node_id` ASC) USING BTREE,
  CONSTRAINT `fk_node_ramnit` FOREIGN KEY (`node_id`) REFERENCES `botnet_nodes_ramnit` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
CREATE TABLE `botnet_communications_test`  (
  ...
  INDEX `idx_is_china`(`is_china` ASC) USING BTREE,
  INDEX `idx_composite`(`ip` ASC, `communication_time` ASC) USING BTREE,
  CONSTRAINT `fk_node_test` FOREIGN KEY (`node_id`) REFERENCES `botnet_nodes_test` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
CREATE TABLE `botnet_nodes_andromeda`  (
  ...
  `communication_count` int(11) NULL DEFAULT 0 COMMENT '通信次数',
...
CREATE TABLE `botnet_timeset_andromeda`  (
  ...
  `global_count` int(11) NOT NULL DEFAULT 0 COMMENT '全球节点数量',
  `china_count` int(11) NOT NULL DEFAULT 0 COMMENT '中国节点数量',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `date`(`date` ASC) USING BTREE,
  INDEX `idx_date`(`date` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 56 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = 'andromeda僵尸网络每日节点数量统计表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `botnet_timeset_asruex`  (
  ...
  UNIQUE INDEX `date`(`date` ASC) USING BTREE,
  INDEX `idx_date`(`date` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 56 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = 'asruex僵尸网络每日节点数量统计表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `botnet_timeset_leethozer`  (
  ...
  UNIQUE INDEX `date`(`date` ASC) USING BTREE,
  INDEX `idx_date`(`date` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 56 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = 'leethozer僵尸网络每日节点数量统计表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `botnet_timeset_moobot`  (
  ...
  UNIQUE INDEX `date`(`date` ASC) USING BTREE,
  INDEX `idx_date`(`date` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 56 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = 'moobot僵尸网络每日节点数量统计表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `botnet_timeset_mozi`  (
  ...
  UNIQUE INDEX `date`(`date` ASC) USING BTREE,
  INDEX `idx_date`(`date` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 56 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = 'mozi僵尸网络每日节点数量统计表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `botnet_timeset_ramnit`  (
  ...
  UNIQUE INDEX `date`(`date` ASC) USING BTREE,
  INDEX `idx_date`(`date` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 56 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = 'ramnit僵尸网络每日节点数量统计表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `botnet_timeset_test`  (
  ...
  UNIQUE INDEX `date`(`date` ASC) USING BTREE,
  INDEX `idx_date`(`date` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 56 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = 'test僵尸网络每日节点数量统计表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `china_botnet_andromeda`  (
  ...
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `communication_count` int(11) NULL DEFAULT 0 COMMENT '通信总次数',
  PRIMARY KEY (`id`) USING BTREE,
...
CREATE TABLE `china_botnet_test`  (
  ...
  `infected_num` int(11) NULL DEFAULT 0 COMMENT '感染数量（节点数）',
  `communication_count` int(11) NULL DEFAULT 0 COMMENT '通信总次数',
  ...
  INDEX `idx_updated_at`(`updated_at` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 633 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '中国地区僵尸网络统计表(按省市)' ROW_FORMAT = DYNAMIC;

DROP TABLE IF EXISTS `china_botnet_test_backup`;
CREATE TABLE `china_botnet_test_backup`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `province` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `municipality` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `infected_num` int(11) NULL DEFAULT 0 COMMENT '感染数量（节点数）',
...
CREATE TABLE `port_consume_task`  (
  ...
  `threads` int(11) NULL DEFAULT 100,
...
CREATE TABLE `syn_flood_task`  (
  ...
  `target_ip` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `target_port` int(11) NOT NULL,
  `threads` int(11) NULL DEFAULT 50,
