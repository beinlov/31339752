...
def generate_timeset_from_communications(days=30):
    """
...
def main():
    ...
    if len(sys.argv) > 1:
        try:
            ...
            print("用法: python generate_timeset_from_communications.py [days]")
            print("示例: python generate_timeset_from_communications.py 30")
            sys.exit(1)
    else:
        days = 30  # 默认30天
    
    success = generate_timeset_from_communications(days)
